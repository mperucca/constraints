...
object AtLeast:
  ...
  given runtimeCheck[Value <: Orderable: ValueOf, Minimum <: Orderable: ValueOf, Orderable: Ordering]: RuntimeComputation.Typed[Value AtLeast Minimum, Boolean] =
  ...
  private def implDouble[Value <: Double : Type, Minimum <: Double : Type](using Quotes): Expr[Null | Boolean] =
    impl[Value, Minimum, Double]

  private def implInt[Value <: Int : Type, Minimum <: Int : Type](using Quotes): Expr[Null | Boolean] =
    impl[Value, Minimum, Int]

  private def implString[Value <: String: Type, Minimum <: String: Type](using Quotes): Expr[Null | Boolean] =
    impl[Value, Minimum, String]

  private def implChar[Value <: Char: Type, Minimum <: Char: Type](using Quotes): Expr[Null | Boolean] =
    impl[Value, Minimum, Char]

  private def impl[Value <: Orderable: Type, Minimum <: Orderable: Type, Orderable <: Extractable: Ordering](using Quotes): Expr[Null | Boolean] =
